...
public class RDouble extends ARObject {
  ...
  public static double getDoubleValue(String s) throws RulesException {
    ...
    try {
      ...
      throw new RulesException(
        ...
        "Could not covert the string '" + s + "' to a double: " + e.getMessage()
      );
    }
  }
   ...
   */
  public static RDouble getRDoubleValue(String s) throws RulesException {
    return getRDoubleValue(getDoubleValue(s));
  }

  public static RDouble getRDoubleValue(double v) {
  ...
  public static RDouble getRDoubleValue(int v) {
    return getRDoubleValue((double) v);
  }

  public static RDouble getRDoubleValue(long v) {
    return getRDoubleValue((double) v);
  }
  ...
  public int compare(IRObject irObject) throws RulesException {
    return (this.value == irObject.doubleValue())
      ? 0
      : ((this.value < irObject.doubleValue()) ? -1 : 0);
  }
