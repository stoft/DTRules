...
public abstract class ARObject implements IRObject {
  ...
  public RArray rArrayValue() throws RulesException {
    throw new RulesException(
      "Conversion Error",
      "ARObject",
      "No Array Value value exists for " + this.stringValue()
    );
  }
  ...
  public Date timeValue() throws RulesException {
    throw new RulesException(
      "Undefined",
      "Conversion Error",
      "No Time value exists for: " + this.type()
    );
  }
  ...
  public int intValue() throws RulesException {
    throw new RulesException(
      "Undefined",
      "Conversion Error",
      "No Integer value exists for " + this.type()
    );
  }
  ...
  public List<IRObject> arrayValue() throws RulesException {
    throw new RulesException(
      "Undefined",
      "Conversion Error",
      "No Array value exists for " + this.type()
    );
  }
  ...
  public boolean booleanValue() throws RulesException {
    throw new RulesException(
      "Undefined",
      "Conversion Error",
      "No Boolean value exists for " + this.type()
    );
  }
  ...
  public double doubleValue() throws RulesException {
    throw new RulesException(
      "Undefined",
      "Conversion Error",
      "No double value exists for " + this.type()
    );
  }
  ...
  public IREntity rEntityValue() throws RulesException {
    throw new RulesException(
      "Undefined",
      "Conversion Error",
      "No Entity value exists for " + this.type()
    );
  }
  ...
  public HashMap<IRObject, IRObject> hashMapValue() throws RulesException {
    throw new RulesException(
      "Undefined",
      "Conversion Error",
      "No HashMap value exists for " + this.type()
    );
  }
  ...
  public long longValue() throws RulesException {
    throw new RulesException(
      "Undefined",
      "Conversion Error",
      "No Long value exists for " + this.type()
    );
  }
  ...
  public RName rNameValue() throws RulesException {
    throw new RulesException(
      "Undefined",
      "Conversion Error",
      "No Name value exists for " + this.type()
    );
  }
  ...
  public int compare(IRObject irObject) throws RulesException {
    throw new RulesException(
      "Undefined",
      "No Supported",
      this.type() + " Objects do not support Compare"
    );
  }
  ...
  public RTable rTableValue() throws RulesException {
    throw new RulesException(
      "Undefined",
      "Not Supported",
      "No Table value exists for " + this.type()
    );
  }
