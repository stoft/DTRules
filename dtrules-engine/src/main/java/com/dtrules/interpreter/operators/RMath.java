...
public class RMath {
  ...
  public static class FNegate extends ROperator {
    ...
    public void execute(DTState state) throws RulesException {
      state.datapush(RDouble.getRDoubleValue(-state.datapop().doubleValue()));
    }
  }
  ...
  public static class FAbs extends ROperator {
    ...
    public void execute(DTState state) throws RulesException {
      state.datapush(
        RDouble.getRDoubleValue(Math.abs(state.datapop().doubleValue()))
      );
    }
  }
  ...
  public static class Abs extends ROperator {
    ...
    public void execute(DTState state) throws RulesException {
      state.datapush(
        RInteger.getRIntegerValue(Math.abs(state.datapop().intValue()))
      );
    }
  }
  ...
  public static class Negate extends ROperator {
    ...
    public void execute(DTState state) throws RulesException {
      state.datapush(RInteger.getRIntegerValue(-state.datapop().intValue()));
    }
  }
    ...
    public void execute(DTState state) throws RulesException {
      state.datapush(
        RInteger.getRIntegerValue(
          state.datapop().longValue() + state.datapop().longValue()
        )
      );
    }
  }
  ...
  public static class FAdd extends ROperator {
    ...
    public void execute(DTState state) throws RulesException {
      ...
      state.datapush(
        RDouble.getRDoubleValue(a.doubleValue() + b.doubleValue())
      );
    }
  }
  ...
  public static class FMul extends ROperator {
    ...
    public void execute(DTState state) throws RulesException {
      ...
      state.datapush(
        RDouble.getRDoubleValue(d1.doubleValue() * d2.doubleValue())
      );
    }
  }
