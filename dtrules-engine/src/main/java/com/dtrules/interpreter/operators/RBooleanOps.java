...
public class RBooleanOps {
  ...
  public static class FEqual extends ROperator {
    ...
    public void execute(DTState state) throws RulesException {
      state.datapush(
        RBoolean.getRBoolean(
          state.datapop().doubleValue() == state.datapop().doubleValue()
        )
      );
    }
  }
  ...
  public static class Isnull extends ROperator {
    ...
    public void execute(DTState state) throws RulesException {
      state.datapush(
        RBoolean.getRBoolean(state.datapop().type().getId() == IRObject.iNull)
      );
    }
  }
  ...
  public static class Booleannotequal extends ROperator {
    ...
    public void execute(DTState state) throws RulesException {
      state.datapush(
        RBoolean.getRBoolean(
          state.datapop().booleanValue() != state.datapop().booleanValue()
        )
      );
    }
  }
