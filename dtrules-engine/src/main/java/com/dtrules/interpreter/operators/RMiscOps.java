...
public class RMiscOps {
  ...
  public static class RError extends ROperator {
    ...
    public void execute(DTState state) throws RulesException {
      ...
      try {
        throw new RulesException("exception", "User Exception", message);
      } catch (Exception e) {
  ...
  public static class Entitypush extends ROperator {
    ...
    public void execute(DTState state) throws RulesException {
      ...
      try {
        ...
        ex.addToMessage(
          "entitypush could not convert a " + o.type() + " to an Entity"
        );
        throw ex;
      }
      state.entitypush(e);
  ...
  public static class Find extends ROperator {
    ...
    public void execute(DTState state) throws RulesException {
      ...
      if (v == null) throw new RulesException(
        "Undefined",
        "find",
        name + " is undefined"
      );
  ...
  public static class Xdef extends ROperator {
    ...
    public void execute(DTState state) throws RulesException {
      ...
      IRObject value = state.datapop();
      boolean f = state.def(name, value, true);
      if (!f) if (state.find(name) == null) {
        throw new RulesException("Undefined", "xdef", name + " is undefined");
      } else {
        throw new RulesException(
          "Write Protection",
          "xdef",
  ...
  public static class Createentity extends ROperator {
    ...
    public void execute(DTState state) throws RulesException {
      ...
      IREntity entity =
        ((RSession) state.getSession()).createEntity(null, ename);
