...
public class RString extends ARObject {
   ...
   * @return
   */
  public static RString newRString(String v) {
   ...
   * @return
   */
  public static RString newRString(String v, boolean executable) {
   ...
   */
  public static IRObject compile(
    IRSession session,
    String v,
    boolean executable
  ) throws RulesException {
   ...
   * @throws RulesException
   */
  private static IRObject compile(
    RuleSet ruleset,
   ...
   * @throws RulesException
   */
  public IRObject compile(IRSession session, boolean executable)
    throws RulesException {
