...
public class DataMap implements IXMLPrinter {
   ...
   * @param out
   */
  public static void print(XMLPrinter xout, XMLNode tag) {
  ...
  private void newtag(String tag) {
    ...
    if (t != null && top().getBody() != null) {
      throw new RuntimeException(
        "You can't have tags and body text within the same XML tag!"
      );
    }
  ...
  public void opentag(Object obj, String tag) {
    ...
    if (doMap == null) {
      throw new RuntimeException(
        "Attempt to map data into the EDD using an Unknown Data Object: " +
        do_name
      );
    }
