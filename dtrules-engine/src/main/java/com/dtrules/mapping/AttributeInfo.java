  ...
  public void add(
    ...
    if (attribType == null) {
      throw new RuntimeException(
        "Invalid mapping type encountered in mapping file: " + _type
      ); //NOPMD
    }
    ...
    while (iattribs.hasNext()) {
      ...
      if (attrib.enclosure.equalsIgnoreCase(_entity)) {
        ...
        if (
          attrib.rAttribute.equalsIgnoreCase(_attribute) &&
        ...
        String errorString =
          ...
          "'\n" +
          "            type      '" +
          type2String.get(attrib.type).stringValue() +
          "'\n" +
          "  New:      RAttribute '" +
          _attribute +
          "'\n" +
        ...
        if (thisisanerror) throw new RuntimeException(
          "Duplicate Enclosures encountered:\r\n" + errorString
        );
      }
    }
