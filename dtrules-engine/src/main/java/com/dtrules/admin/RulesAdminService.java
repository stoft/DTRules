...
public class RulesAdminService implements IRulesAdminService {
  ...
  public boolean createAttribute(
    ...
    final REntityEntry attribute
  ) {
    IREntity entity = session
      .getEntityFactory()
      .findRefEntity(attribute.attribute);
   ...
   */
  public List<REntityEntry> getEntityEntries(
    String rulesetname,
    String entityname
  ) {
    ...
    IREntity entity;
    entity =
      session.getEntityFactory().findRefEntity(RName.getRName(entityname));
   ...
   */
  public RDecisionTable createDecisionTable(
    String rulesetname,
    String decisiontablename
  ) throws RulesException {
    return session
      .getEntityFactory()
      .newDecisionTable(decisiontablename, session);
  }
  ...
  public List<?> getAttributes(String rulesetname, String entityName) {
    ...
    Iterator<?> it = session
      .getEntityFactory()
      .findRefEntity(RName.getRName(entityName))
   ...
   */
  public RDecisionTable getDecisionTable(
    String rulesetname,
    String DecisionTableName
  ) {
    return session
  ...
  public List<String> getRulesets() {
    ...
    for (
      Iterator it = rulesDirectory.getRulesets().keySet().iterator();
      it.hasNext();
    ) {
   ...
   */
  public void saveDecisionTables(RSession session, String rulesetname)
    throws RulesException {
   ...
   * @throws RulesException
   */
  public void saveDecisionTables(
    OutputStream out,
    RSession session,
    String rulesetname
  ) throws RulesException {
  ...
  public void saveEDD(RSession session, String rulesetname)
    throws RulesException {
    RuleSet rs = rulesDirectory.getRuleSet(RName.getRName(rulesetname));
    EntityFactory ef = session.getEntityFactory();
    String filepath = rs.getFilepath();
