...
public class CompilerError implements IDecisionTableError {
  ...
  private final Type errorType; //NOPMD Supid PMD wants a set method for a final field...
  private final String message; //NOPMD
  private final String source; //NOPMD Only valid for type ACTION or CONDITION
  ...
  private final int index; //NOPMD Only valid for type INITIALACTION,
  //  ACTION, andCONDITON
  private final int row; //NOPMD Only valid for type TABLE
  private final int col; //NOPMD Only valid for type TABLE
