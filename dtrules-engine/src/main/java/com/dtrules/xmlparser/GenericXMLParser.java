...
public class GenericXMLParser {
  ...
  String popTag(String endtag) {
    ...
    if (!tag.equals(endtag)) {
      System.err.print(
        "Begin and End tags do not match:\n" +
        "Begin tag: " +
        tag +
        "\n" +
        "End tag:   " +
  ...
  void error(String v) throws Exception {
    if (!parser.error(v)) {
      throw new Exception(
        "Unmatched characters, parsing cannot continue at" + where()
      );
    }
  }

  private static Pattern xamp = Pattern.compile("&amp;");
  private static Pattern xlt = Pattern.compile("&lt;");
  private static Pattern xgt = Pattern.compile("&gt;");
  private static Pattern xsqu = Pattern.compile("&apos;");
  private static Pattern xdqu = Pattern.compile("&quot;");
  ...
  private static Pattern tst = Pattern.compile("[&<>'\"]+");
  private static Pattern amp = Pattern.compile("&");
  private static Pattern lt = Pattern.compile("<");
  private static Pattern gt = Pattern.compile(">");
  private static Pattern squ = Pattern.compile("'");
  private static Pattern dqu = Pattern.compile("\"");
  ...
  public static StringBuffer encode(StringBuffer sb) {
   ...
   */
  public static void load(java.io.InputStream xmlStream, IGenericXMLParser2 gp)
    throws Exception {
   ...
   * @param gp    A parser implementing the IGenericXMLParser interface.
   */
  public static void load(java.io.InputStream xmlStream, IGenericXMLParser gp)
    throws Exception {
    GenericXMLParser parser = new GenericXMLParser(xmlStream);
    parser.setParser(gp);
    while (true) {
   ...
   * @throws Exception
   */
  public static void load(java.io.Reader xmlStream, IGenericXMLParser2 gp)
    throws Exception {
    GenericXMLParser parser = new GenericXMLParser(xmlStream);
    parser.setParser(gp);
    while (true) {
   ...
   * @throws Exception
   */
  public static void load(java.io.Reader xmlStream, IGenericXMLParser gp)
    throws Exception {
    GenericXMLParser parser = new GenericXMLParser(xmlStream);
    parser.setParser(gp);
    while (true) {
   ...
   * @param gp    A parser implementing the IGenericXMLParser interface.
   */
  public static void load(java.io.InputStream xmlStream, AGenericXMLParser gp)
    throws Exception {
    GenericXMLParser parser = new GenericXMLParser(xmlStream);
