...
public class RulesDirectory {
  ...
  public Class<ICompiler> getDefaultCompiler() throws RulesException {
    if (defaultCompiler == null) {
      try {
        defaultCompiler =
          (Class<ICompiler>) Class.forName("com.dtrules.compiler.el.EL");
  ...
  public void setDefaultCompiler(String qualifiedCompilerClassName) {
    try {
      ...
      System.err.println(
        "WARNING:  Cannot find the specfied compiler: " +
        qualifiedCompilerClassName
      );
    }
  }
  ...
  public void load(String systemPath, String propertyfile) {
    ...
    InputStream s = streamSource.openstream(
      IStreamSource.FileType.DTRULES_CONFIG,
      f
    );
  ...
  public void loadRulesDirectory(InputStream s) {
    ...
    if (s == null) {
      throw new RuntimeException(
        "Could not find the file/inputstream: " +
        systemPath +
        "/" +
        propertyfile
      );
    ...
    try {
      ...
      throw new RuntimeException(
        "Error parsing property file/inputstream: " +
        systemPath +
        "/" +
        propertyfile +
        "\n" +
      ...
      if (currentset == null) {
        if (tag.equals("DTRules")) {
          ...
          throw new RulesException(
            "undefined",
            "RulesDirectory",
            "Unexpected tag encountered: " + tag
          );
        }
      } else {
        ...
        } else if (tag.equals("EDDExcelFile") || tag.equals("EDDExcelFolder")) {
